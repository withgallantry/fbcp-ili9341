...
#error Please define -DSPI_BUS_CLOCK_DIVISOR=<some even number> on the CMake command line! (see file ili9342.h for details). This parameter along with core_freq=xxx in /boot/config.txt defines the SPI display speed.
#endif
...
#ifdef ADAFRUIT_ILI9342_PITFT
#include "pitft_28r_ili9342.h"
...
#error Please reconfigure CMake with -DADAFRUIT_ILI9342_PITFT=ON, -FREEPLAYTECH_WAVESHARE32B=ON or -DILI9342=ON (or contribute ports to more displays yourself)
#endif
